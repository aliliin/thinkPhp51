...
class RuleItem extends Rule
{
    ...
    public function setRule($rule)
    {
        ...
        if (false !== strpos($rule, ':')) {
            ...
            //  $this->rule   =  (index/:index) 转换为 index/<index>
            /* $this->rule   =  (index/[:index]) 转换为 index/<index?> */
        } else {
            $this->rule = $rule;
        }
    ...
    {
//        halt($this->name); index/hello 的路由地址
        if ($this->name) {
...
//        dump($this->pattern);
        ...
        if ($matchRule = preg_split('/[' . $slash . ']?<\w+\??>/', $rule, 2)) {
             ...
             */
            // strncasecmp PHP内置方法，字符串比较，；
//            dump([$rule,$url]);
            /*
             * array(2) {
              [0] => string(13) "/hello/<name>"
              [1] => string(10) "/test/1122"
            }
            array(2) {
              [0] => string(10) "/test/<na>"
              [1] => string(10) "/test/1122"
