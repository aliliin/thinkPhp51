...
//    echo $this->appPath;die; /var/www/html/thinkPhp51/application/
        // 注册应用命名空间
        Loader::addNamespace($this->namespace, $this->appPath);

        // 初始化应用 ( 会被多次调用)
        // /var/www/html/thinkPhp51/thinkphp/library/think/App.php 211 行; 调用
        // /var/www/html/thinkPhp51/thinkphp/library/think/route/dispatch/Module.php  61 行 调用
        $this->init();
    ...
    public function init($module = '')
    {
        ...
        // /var/www/html/thinkPhp51/thinkphp/library/think/App.php 211 行;
        // /var/www/html/thinkPhp51/thinkphp/library/think/route/dispatch/Module.php  61 行
//         var_dump($array);
        // 定位模块目录
//        die;
...
//        $this->setModulePath($path);
    ...
    public function run()
    {
        try {
            ...
            if (empty($dispatch)) {
                ...
                /* 初始化
                 object(think\route\dispatch\Module)#16 (6) {
                 ...
                 */
                /* 指定控制器
                object(think\route\dispatch\Module)#17 (6) {
                  ["controller"] => string(5) "index"
                  ["actionName"] => string(5) "test1"
                  ["dispatch"] => array(3) {
                    [0] => string(5) "index"
                    [1] => string(5) "index"
                    [2] => string(5) "test1"
    ...
    public function routeCheck()
    {
       ...
       /*
        object(think\route\dispatch\Url)#16 (4) {
          ["dispatch"] => string(17) "index|index|test1"
          ["param"] => array(1) {
